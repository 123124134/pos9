                                ...
                                <table class="table table-bordered table-left">
                                    ...
                                    <tbody class="addMoreProduct">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <input type="number" name="product_amount[]" id="total"
                                ...
                                <div class="card-body">
                                    <div class="btn-group">
                                        <button type="button" onclick="PrintReceiptContent('print')"
                                            class="btn btn-dark"><i class="fas fa-print"></i> Print</button>

                                        <button type="button" onclick="PrintReceiptContent('print')"
                                            class="btn btn-primary"><i class="fas fa-print"></i> Histroy</button>

                                        <button type="button" onclick="PrintReceiptContent('print')"
                                            class="btn btn-danger"><i class="fas fa-print"></i> Report</button>
                                    </div>
                                    <div class="panel">
                                        <div class="row">
