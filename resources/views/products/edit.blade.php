    ...
    <div class="modal-dialog ">
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <form action="{{ route('products.update', $product->id) }}" method="post" enctype="multipart/form-data" autocomplete="">
                    @csrf
                    @method('put')
                    <div class="form-group">
                        ...
                        <input type="text" name="product_name" id="" value="{{ $product->product_name }}"
                            ...
                            <input type="hidden" name="product_code" id="" value="{{ $product->product_code }}"
                    ...
                    <div class="form-group">
                        ...
                        <input type="number" name="alert_stock" id="" value="{{ $product->alert_stock }}"
                            class="form-control">
                    </div>
                    <div class="form-group">
