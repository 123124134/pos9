    ...
    @forelse ($products_details as $product)
        <div class="col-md-12">
            <div class="form-group">
                ...
                <img data-toggle="modal" data-target="#productPreview{{ $product->id }}"
                    src="{{ asset('products/images/' . $product->product_image) }}" width="70"
        ...
        <div class="col-md-12">
            <div class="form-group">
                ...
                <textarea class="form-control" readonly cols="10" rows="2">{{ $product->desc }}</textarea>
        ...
        <div class="col-md-12">
            <div class="form-group" style="text-align:center !important; padding-left:8%;">
                <span style="text-align:center;">
                    <img src="{{ asset('products/barcodes/' . $product->barcode) }}" width="70"
                        style=" cursor: pointer;" alt="">
                </span>
